#include "firmwares/fixedwing/stabilization/stabilization_mfc.h"
#include "state.h"
#include "std.h"
...
/* Parameters for pitch MFC controller */
...
/* Parameters for roll MFC controller */
...
pprz_t mfc_aileron_setpoint_pprz;
...
void stabilization_mfc_run(void)
{
  ...
  mfc_elevator_setpoint_pprz = -stabilization_mfc_calc_cmd(&mfc_pitch, att->theta);
  mfc_aileron_setpoint_pprz  =  stabilization_mfc_calc_cmd(&mfc_roll, att->phi);
